...
export function ExpandableCardDemo({ projectCards }) {
  ...
  return (
    <>
                ...
                <div className="flex items-start justify-between p-4">
                  <div className="">
                    ...
                    <motion.p
                      ...
                      className="dark:text-400 text-base text-neutral-600"
                    >
                      {active.description}
                    </motion.p>
                  </div>
      ...
      <ul className="mx-auto grid w-full max-w-2xl grid-cols-1 items-start gap-6 md:grid-cols-2">
            ...
            <div className="flex w-full flex-col gap-4">
              ...
              <div className="flex flex-col items-center justify-center">
                <motion.h3
                  ...
                  className="text-center text-base font-medium text-sky-200 dark:text-neutral-200 md:text-left"
                >
                  {card.title}
                </motion.h3>
                <motion.p
                  layoutId={`description-${card.description}-${id}`}
                  className="text-center text-base text-white dark:text-neutral-400"
                >
                  {card.description}
                </motion.p>
              </div>
