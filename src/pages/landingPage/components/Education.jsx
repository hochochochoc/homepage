        ...
        <div className="flex flex-col items-center justify-center gap-4">
          {education.map((item) => (
            <motion.div
              ...
              className="w-2/3 rounded-3xl bg-blue-950 p-4 text-blue-500 shadow-md transition-colors duration-500 hover:border hover:border-blue-500 hover:bg-gradient-to-r hover:from-blue-900 hover:to-cyan-900 hover:text-blue-50 hover:opacity-20"
            >
